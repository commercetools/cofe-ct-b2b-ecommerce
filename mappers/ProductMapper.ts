...
import { Attributes } from '@b2bdemo/types/types/product/Attributes';
import { Category } from '@b2bdemo/types/types/product/Category';
import { Money } from '@b2bdemo/types/types/product/Money';
import { FilterField, FilterFieldTypes, FilterFieldValue } from '@b2bdemo/types/types/product/FilterField';
import {
  AttributeEnumType,
...
import { Facet, FacetTypes } from '@b2bdemo/types/types/result/Facet';
import { TermFacet } from '@b2bdemo/types/types/result/TermFacet';
import { RangeFacet as ResultRangeFacet } from '@b2bdemo/types/types/result/RangeFacet';
import { Term } from '@b2bdemo/types/types/result/Term';
import { ProductQuery } from '@b2bdemo/types/types/query/ProductQuery';
import { TermFacet as QueryTermFacet } from '@b2bdemo/types/types/query/TermFacet';
import { RangeFacet as QueryRangeFacet } from '@b2bdemo/types/types/query/RangeFacet';
import { Facet as QueryFacet } from '@b2bdemo/types/types/query/Facet';
